...
export const GET = withRouteTelemetry("webhook.deliveries.list.v1", async (baseRequest) => {
  ...
  try {
    const result = await convex.query(api.projects.query.verifyApiKeyAndGetWebhookDeliveries, {
      apiKeyHash,
      limit,
    });
