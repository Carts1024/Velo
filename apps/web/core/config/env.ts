...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_TALAKIT_REGISTRY_CONTRACT_ID: z.string().optional(),
});
...
const validateEnv = () => {
  const parsed = envSchema.safeParse({
    ...
    NEXT_PUBLIC_TALAKIT_REGISTRY_CONTRACT_ID: process.env.NEXT_PUBLIC_TALAKIT_REGISTRY_CONTRACT_ID,
  });
